...
class FaixaImcTest extends Specification {
	...
	def 'IMC deve estar na faixa correta cenario 1'() {
		expect:
	...
	def 'IMC deve estar na faixa correta cenario 2'(){
	...
	def 'IMC deve estar na faixa correta cenario 3 data driven'(){
